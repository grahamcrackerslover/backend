...
urlpatterns = [
    ...
    path("update_profile/", views.update_profile, name="custom-user-update-profile"),
    path("update_photo/", views.update_profile_picture, name="custom-user-update-profile-picture"),
]
